...
describe('TodoItem', () => {
    ...
    it('strikes through the item if it is completed', () => {
        ...
        expect(todo[0].classList.contains('completed'))
            .to
            .equal(true);
    });
    ...
    it('should look different when editing', () => {
        ...
        expect(todo[0].classList.contains('editing'))
            .to
            .equal(true);
    });
    ...
    it('should be checked if the item is completed', () => {
        ...
        const component = renderIntoDocument(
            <TodoItem text={text} isCompleted={true}/>, < TodoItem text = {
            text2
        }
        isCompleted = {
            false
        ...
        expect(input[0].checked)
            .to
            .equal(true);
        expect(input[1].checked)
            .to
            .equal(false);
    });
